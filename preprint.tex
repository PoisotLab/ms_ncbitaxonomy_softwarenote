...
the NCBI taxonomic backbone (Federhen 2012; Schoch \emph{et al.} 2020);
The basic search functions are coupled with quality-of-life functions
...
language (Bezanson \emph{et al.} 2017), and relies on the Apache Arrow
format to store a local copy of the NCBI raw taxonomy files. The design
of \texttt{NCBITaxonomy.jl} has been inspired by similar efforts, like
the R package \texttt{taxadb} (Norman \emph{et al.} 2020), which
provides an offline alternative to packages like \texttt{taxize}
...
\emph{e.g} Lefkowitz \emph{et al.} (2018) to Walker \emph{et al.}
(2020).
...
hyper-diverse samples, like plant census (Dauncey \emph{et al.} 2016;
Wagner 2016; Conti \emph{et al.} 2021). In addition to binomial names,
the same species can be known by many vernacular (common) names, which
are language or even region-specific: \emph{Ovis aries}, for example,
has valid English vernaculars including lamb, sheep, wild sheep, and
domestic sheep.
...
\emph{CLOVER} database (Gibb \emph{et al.} 2021) of host-virus
...
retrieval in R. \emph{F1000Research}, 2, 191.

\leavevmode\hypertarget{ref-Conti2021MatAlg}{}%
Conti, M., Nimis, P.L. \& Martellos, S. (2021). Match Algorithms for
Scientific Names in FlorItaly, the Portal to the Flora of Italy.
\emph{Plants}, 10, 974.

\leavevmode\hypertarget{ref-Dauncey2016ComMis}{}%
Dauncey, E.A., Irving, J., Allkin, R. \& Robinson, N. (2016). Common
mistakes when using plant names and how to avoid them. \emph{European
Journal of Integrative Medicine}, 8, 597--601.

\leavevmode\hypertarget{ref-Federhen2012NcbTax}{}%
Federhen, S. (2012). The NCBI taxonomy database. \emph{Nucleic acids
research}, 40, D136--D143.

\leavevmode\hypertarget{ref-Gibb2021DatPro}{}%
Gibb, R., Albery, G.F., Becker, D.J., Brierley, L., Connor, R., Dallas,
T.A., \emph{et al.} (2021). Data proliferation, reconciliation, and
synthesis in viral ecology. \emph{bioRxiv}, 2021.01.14.426572.
...
International Committee on Taxonomy of Viruses (ICTV). \emph{Nucleic
Acids Research}, 46, D708--D717.

\leavevmode\hypertarget{ref-Norman2020TaxHig}{}%
Norman, K.E.A., Chamberlain, S. \& Boettiger, C. (2020). Taxadb: A
...
Khovanskaya, R., \emph{et al.} (2020). NCBI Taxonomy: A comprehensive
update on curation, resources and tools. \emph{Database}, 2020.

\leavevmode\hypertarget{ref-Shimatani2001MeaSpe}{}%
Shimatani, K. (2001). On the Measurement of Species Diversity
Incorporating Species Differences. \emph{Oikos}, 93, 135--147.

\leavevmode\hypertarget{ref-Wagner2016RevSof}{}%
Wagner, V. (2016). A review of software tools for spell-checking taxon
names in vegetation databases. \emph{Journal of Vegetation Science}, 27,
1323--1327.

\leavevmode\hypertarget{ref-Walker2020ChaVir}{}%
Walker, P.J., Siddell, S.G., Lefkowitz, E.J., Mushegian, A.R.,
Adriaenssens, E.M., Dempsey, D.M., \emph{et al.} (2020). Changes to
virus taxonomy and the Statutes ratified by the International Committee
on Taxonomy of Viruses (2020). \emph{Archives of Virology}, 165,
2737--2748.
